...
<template>
  ...
  <div class="container mx-auto px-5 py-11">
    <p class="text-3xl font-semibold text-white px-5 border-l-2 py-5 border-l-blue-600 mb-11">{{ t('projects.aboutUs') }}</p>
    <p class="mb-10 text-[#797a7c] text-xl">{{ t('projects.marketing') }}</p>
