...
<template>
  ...
  <div class="container mx-auto px-5 py-11">
    ...
    <ul>
      <li class="mb-10 text-xl">{{ t('projects.buxgalteriya.begin') }}</li>
      <li class="mb-5 ml-5  text-xl">{{ t('projects.buxgalteriya.first') }}</li>
      <li class="mb-5 ml-5  text-xl">{{ t('projects.buxgalteriya.second') }}</li>
      <li class="mb-5 ml-5  text-xl">{{ t('projects.buxgalteriya.third') }}</li>
      <li class="mb-5 ml-5  text-xl">{{ t('projects.buxgalteriya.fourth') }}</li>
      <li class="mb-5 ml-5  text-xl">{{ t('projects.buxgalteriya.fifth') }}</li>
      <li class="mb-5 ml-5  text-xl">{{ t('projects.buxgalteriya.sixth') }}</li>
      <li class="mt-10  text-xl">{{ t('projects.buxgalteriya.last') }}</li>
    </ul>
