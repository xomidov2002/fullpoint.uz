  ...
  <div
    ...
    <div class="container relative mx-auto px-5 select-none">
      <p
        ...
        {{ t('ourServices.buxgalteriya') }}</p>
    </div>
  </div>
  <div class="container mx-auto px-5 py-11">
    <p class="text-3xl text-white font-semibold px-5 border-l-2 py-5 border-l-blue-600 mb-11">{{ t('projects.aboutUs') }}</p>
    <ul>
      <li class="text-white mb-10 text-xl">{{ t('projects.buxgalteriya.begin') }}</li>
      <li class="text-white mb-5 ml-5  text-xl">{{ t('projects.buxgalteriya.first') }}</li>
      <li class="text-white mb-5 ml-5  text-xl">{{ t('projects.buxgalteriya.second') }}</li>
      <li class="text-white mb-5 ml-5  text-xl">{{ t('projects.buxgalteriya.third') }}</li>
      <li class="text-white mb-5 ml-5  text-xl">{{ t('projects.buxgalteriya.fourth') }}</li>
      <li class="text-white mb-5 ml-5  text-xl">{{ t('projects.buxgalteriya.fifth') }}</li>
      <li class="text-white mb-5 ml-5  text-xl">{{ t('projects.buxgalteriya.sixth') }}</li>
      <li class="text-white mt-10  text-xl">{{ t('projects.buxgalteriya.last') }}</li>
    </ul>
